...
- [TOOLS](#TOOLS)
- [DATA EXPLORATION AND PREPARATION](#DATAEXPLORATIONANDPREPARATION)
- [EXCEL ANALYSIS](#EXCELANALYSIS)
- [SQL QUERIES](#SQL.QUERIES)
- [POWERBI VISUALISATION](#POWERBIVISUALIZATION)
- [KEY INSIGHTS AND IMPLICATIONS](#KEYINSIGHTSANDIMPLICATION)
